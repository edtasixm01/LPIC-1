...
[ move & rename ] (active directory is /tmp/lpi)
 ...
 18. Move directory captures (/tmp/lpi/mynet/captures) to test (/tmp/lpi/test). Verify the contents of test, using ls and tree.
...
[  ]
 ...
 38. Find the files in the /tmp directory uwned by root.
